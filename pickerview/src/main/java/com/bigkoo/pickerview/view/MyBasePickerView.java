...
public class MyBasePickerView {
    ...
    protected MyPickerOptions mPickerOptions;
        ...
        mPickerOptions.decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(MyBasePickerView.this);
                }
            }
        });
    ...
    public MyBasePickerView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    protected MyBasePickerView setOutSideCancelable(boolean isCancelable) {
