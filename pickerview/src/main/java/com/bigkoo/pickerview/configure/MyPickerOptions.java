...
public class MyPickerOptions {
    ...
    //constant
    private static final int PICKER_VIEW_BTN_COLOR_NORMAL = 0xFF2255FF;
    private static final int PICKER_VIEW_BTN_COLOR_SUBMIT = 0xFFC1C1D6;
    private static final int PICKER_VIEW_BG_COLOR_TITLE = 0xFFFFFFFF;
    private static final int PICKER_VIEW_COLOR_TITLE = 0xFF8383A3;
    ...
    public MyPickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.my_pickerview_options;
        } else {
            layoutRes = R.layout.my_pickerview_time;
        }
    }
    ...
    public int textColorCancel = PICKER_VIEW_BTN_COLOR_SUBMIT;//取消按钮颜色
    ...
    public int bgdrawableTitle = -1;//标题背景
    ...
    public int textColorCenter = 0xFF30303D; //分割线之间的文字颜色
    public int dividerColor = 0xFFFFFFFF; //分割线的颜色
    ...
    public int mNavigationBarHeight=0;//设置导航栏高度
