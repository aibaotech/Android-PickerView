 ...
 */
public class VinKeyboardInputController {

    private static final String TAG = "VinKeyboardController";

    private final VinKeyboardView mKeyboardView;
    private final VinInputView mInputView;
     ...
     */
    public VinKeyboardInputController(VinKeyboardView keyboardView, VinInputView inputView) {
        mKeyboardView = keyboardView;
        mInputView = inputView;
        // 绑定输入框被选中的触发事件：更新键盘
        mInputView.addOnFieldViewSelectedListener(new VinInputView.OnFieldViewSelectedListener() {
            @Override
            public void onSelectedAt(int index) {
                ...
                mKeyboardView.update(number, index, false, NumberType.VIN);
            }
        });
     ...
     */
    public static VinKeyboardInputController with(VinKeyboardView keyboardView, VinInputView inputView) {
        return new VinKeyboardInputController(keyboardView, inputView);
    }
     ...
     * @return KeyboardInputController
     */
    public VinKeyboardInputController bindLockTypeProxy(final LockNewEnergyProxy proxy) {
        // 点击按钮时，切换新能源车牌绑定状态
     ...
     */
    public VinKeyboardInputController useDefaultMessageHandler() {
     ...
     * @return KeyboardBinder
     */
    public VinKeyboardInputController setMessageHandler(MessageHandler handler) {
     ...
     * @return KeyboardInputController
     */
    public VinKeyboardInputController addOnInputChangedListener(OnInputChangedListener listener) {
     ...
     * @return KeyboardInputController
     */
    public VinKeyboardInputController removeOnInputChangedListener(OnInputChangedListener listener) {
     ...
     * @return KeyboardInputController
     */
    public VinKeyboardInputController setSwitchVerify(boolean verify) {
     ...
     * @return KeyboardInputController
     */
    public VinKeyboardInputController setDebugEnabled(boolean enabled) {
